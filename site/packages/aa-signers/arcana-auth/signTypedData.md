...
head:
  - - meta
    - property: og:title
      content: ArcanaAuthSSigner • signTypedData
  - - meta
    - name: description
      content: Overview of the signTypedData method on ArcanaAuthSSigner
  - - meta
...
const signedTypedData = await ArcanaAuthSSigner.signTypedData({
  domain: {
    name: "Ether Mail",
    version: "1",
    chainId: 1,
